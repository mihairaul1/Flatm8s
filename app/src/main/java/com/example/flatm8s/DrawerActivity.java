...
public class DrawerActivity extends AppCompatActivity
    ...
    public void updateNavHeader(){
        ...
        final TextView navUserEmail = headerView.findViewById(R.id.tv_nav_useremail);
        final ImageView navUserPhoto = headerView.findViewById(R.id.iv_nav_userphoto);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                navUserEmail.setText(userProfile.getUserEmail());
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(DrawerActivity.this, databaseError.getCode(), Toast.LENGTH_LONG).show();
            }
        });

        // Retrieving user's picture using Picasso
